      ...
      >
        ...
        <div className="fixed inset-0 overflow-y-auto text-white">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-sm transform overflow-hidden rounded-2xl bg-[#25224f] p-6 text-left align-middle shadow-xl transition-all">
                <button
                  className="absolute top-4 right-6 text-grey-500 hover:text-white"
                ...
                <div className="flex flex-col items-center">
                  ...
                  <Dialog.Title
                    as="h3"
                    className="text-xl font-medium leading-6 text-gray-300 mb-8"
                  >
                    {title}
                  </Dialog.Title>
                  {description && (
                  ...
                  {buttonText && buttonHref && (
                    <div
                      ...
                      } px-7 py-3 mb-8 text-lg text-center hover:cursor-pointer`}
                    >
